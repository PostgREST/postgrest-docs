...
The output of the plan is generated in ``json`` format by default:
...
The same execution can be returned in text format by using the ``Accept: application/vnd.pgrst.plan+text`` header instead:
